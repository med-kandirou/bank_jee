...
public class ImpEmploye implements IEmploye {
    ...
    public Optional<Employe> add(Employe employe) {
        try {
            String insertSql = "insert into employe (matricule, nom, prenom, datenaissance, telephone, adresseemail,datederecrutement) values (?,?,?,?,?,?,?)";
    ...
    public Optional<Employe> update(Employe employe) {
        try {
            String updateSql = "UPDATE employe SET nom = ?, prenom = ?, datenaissance = ?, telephone = ?, adresseemail = ?, datederecrutement = ? WHERE matricule like ?";
    ...
    public ArrayList<Employe> getAll() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                LocalDate datederecrutement=resultSet.getDate("datederecrutement").toLocalDate();
    ...
    public ArrayList<Employe> search(String param) {
        ArrayList<Employe> employes= new ArrayList<>();
        try {
            String selectSql = "SELECT * FROM employe where matricule like ? or nom like ? or prenom like ? or telephone like ? or adresseemail like ?";
            PreparedStatement preparedStatement = cnx.prepareStatement(selectSql);
